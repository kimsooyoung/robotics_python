...
def hip_positions(float l1, float l2, float phi, float phi_lh, float phi_rh, float psi_lh, float psi_rh, float psi, float theta, float theta_lh, float theta_lk, float theta_rh, float theta_rk, float w):
    
    cdef float t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28
    cdef float et1, et2, et3, et4, et5, et6, et7, et8

    cdef float pos_hip_l_stance0, pos_hip_l_stance1, pos_hip_l_stance2, pos_hip_l_stance3
    cdef float pos_hip_r_stance0, pos_hip_r_stance1, pos_hip_r_stance2, pos_hip_r_stance3

    cdef cnp.ndarray[DTYPE_t, ndim=1] pos_hip_l_stance = np.zeros([4], dtype=DTYPE)
    cdef cnp.ndarray[DTYPE_t, ndim=1] pos_hip_r_stance = np.zeros([4], dtype=DTYPE)
    ...
    pos_hip_l_stance0 = t26+l1*t3*t9*t19-l1*t5*t7*t8*t20+l2*t3*t9*t10*t19+l1*t8*t16*t18*t20-l2*t3*t19*t20*t21-l2*t5*t7*t8*t9*t21-l2*t5*t7*t8*t10*t20+l1*t5*t8*t9*t14*t18+l1*t7*t8*t9*t14*t16+l2*t8*t9*t16*t18*t21+l2*t8*t10*t16*t18*t20+l2*t5*t8*t9*t10*t14*t18+l2*t7*t8*t9*t10*t14*t16-l2*t5*t8*t14*t18*t20*t21-l2*t7*t8*t14*t16*t20*t21
    pos_hip_l_stance1 = et1+et2
    pos_hip_l_stance2 = et3+et4
    pos_hip_l_stance3 = -1.0
    ...
    pos_hip_r_stance0 = -t26+l1*t4*t11*t19-l1*t6*t7*t8*t22+l2*t4*t11*t12*t19-l1*t8*t17*t18*t22-l2*t4*t19*t22*t23-l2*t6*t7*t8*t11*t23-l2*t6*t7*t8*t12*t22-l1*t6*t8*t11*t15*t18+l1*t7*t8*t11*t15*t17-l2*t8*t11*t17*t18*t23-l2*t8*t12*t17*t18*t22-l2*t6*t8*t11*t12*t15*t18+l2*t7*t8*t11*t12*t15*t17+l2*t6*t8*t15*t18*t22*t23-l2*t7*t8*t15*t17*t22*t23
    pos_hip_r_stance1 = et5+et6
    pos_hip_r_stance2 = et7+et8
    pos_hip_r_stance3 = -1.0
    ...
    pos_hip_l_stance[0] = pos_hip_l_stance0
    pos_hip_l_stance[1] = pos_hip_l_stance1
    pos_hip_l_stance[2] = pos_hip_l_stance2
    pos_hip_l_stance[3] = pos_hip_l_stance3

    pos_hip_r_stance[0] = pos_hip_r_stance0
    pos_hip_r_stance[1] = pos_hip_r_stance1
    pos_hip_r_stance[2] = pos_hip_r_stance2
    pos_hip_r_stance[3] = pos_hip_r_stance3
