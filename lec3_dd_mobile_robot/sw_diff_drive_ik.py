...
def animate(params, t_interp, z_interp, z_dot, err):
    ...
    for i in range(0,len(t_interp)):
        ...
        shape, = plt.plot(z_interp[0:i,0], z_interp[0:i,1], color='red', marker="o", markersize=0.5);
...
def motion_simulation(params, path):
    ...
    for i in range(0,len(t)-1):
        ...
        x_c, y_c, _ = sw_dd_helper.robot_to_world(z0, params)
        ...
        z0 = sw_dd_helper.euler_integration([t[i], t[i+1]],z0,[u[0],u[1]])
        z[i+1] = z0
