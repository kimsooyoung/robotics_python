...
with open("two_doublependulum_rhs.py", "w") as f:
    ...
    f.write("def two_double_pendulum(z, t, params): \n\n")
    ...
    f.write("    x = np.linalg.solve(A, b) \n\n")
    f.write("    output = np.array([u1, x[0,0], u2, x[1,0], u3, x[2,0], u4, x[3,0]]) \n\n")
