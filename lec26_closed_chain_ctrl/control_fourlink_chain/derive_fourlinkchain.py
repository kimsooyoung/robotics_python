...
def eq_auto_generation(leg_type):
    # leg = "atrias"
    # leg = "minitaur"
    # leg = "digit"

    if leg_type == "minitaur" or leg_type == "atrias":
        q = sy.Matrix([q1, q3, q2, q4])
        qdot = sy.Matrix([u1, u3, u2, u4])
        qddot = sy.Matrix([a1, a3, a2, a4])
    elif leg_type == "digit":
        q = sy.Matrix([q1, q4, q2, q3])
        qdot = sy.Matrix([u1, u4, u2, u3])
        qddot = sy.Matrix([a1, a4, a2, a3])
    ...
    with open("fourlinkchain_dynamics.py", "w") as f:
        ...
        f.write("def fourlinkchain_dynamics(z, params): \n\n")
        ...
        f.write(f"    return A, b, J, Jdot\n")
        
        print("[File Write] fourlinkchain_dynamics.py Done!")
    ...
    with open("fourlinkchain_rhs.py", "w") as f:
        ...
        f.write("def fourlinkchain_rhs(z, t, params, q1_refs, q2_refs):\n\n")
        f.write("    q1, u1 = z[0], z[1] \n")
        f.write("    q2, u2 = z[2], z[3] \n")
        f.write("    q3, u3 = z[4], z[5] \n")
        f.write("    q4, u4 = z[6], z[7] \n\n")
        f.write("    A, b, J, Jdot = fourlinkchain_dynamics(z, params)\n\n")
        f.write("    T_first, T_second = controller(z, t, params, q1_refs, q2_refs)\n\n")
        ...
        f.write("    x = np.linalg.solve(bigA, bigB)\n\n")
