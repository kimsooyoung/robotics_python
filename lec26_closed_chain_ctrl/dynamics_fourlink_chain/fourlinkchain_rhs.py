...
def fourlinkchain(z, t, params): 
    ...
    J23 = -l3*sin(q3) - l4*sin(q3 + q4)

    J24 = -l4*sin(q3 + q4)

    Jdot11 = -l2*u2*sin(q1 + q2) + u1*(-l1*sin(q1) - l2*sin(q1 + q2))

    Jdot12 = -l2*u1*sin(q1 + q2) - l2*u2*sin(q1 + q2)

    Jdot13 = l4*u4*sin(q3 + q4) + u3*(l3*sin(q3) + l4*sin(q3 + q4))

    Jdot14 = l4*u3*sin(q3 + q4) + l4*u4*sin(q3 + q4)

    Jdot21 = l2*u2*cos(q1 + q2) + u1*(l1*cos(q1) + l2*cos(q1 + q2))

    Jdot22 = l2*u1*cos(q1 + q2) + l2*u2*cos(q1 + q2)

    Jdot23 = -l4*u4*cos(q3 + q4) + u3*(-l3*cos(q3) - l4*cos(q3 + q4))
