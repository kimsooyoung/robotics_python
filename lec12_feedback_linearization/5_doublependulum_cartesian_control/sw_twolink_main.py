...
def get_tau(m1,m2,c1,c2,l,g,I1,I2, theta1,theta2,omega1,omega2, kp1, kd1, kp2, kd2, q1_p_ref, q1_v_ref, q1_a_ref, q2_p_ref, q2_v_ref, q2_a_ref):
...
def twolink_dynamics(z,t, dyn_args, gain_args, ref_args):
    ...
    tau = get_tau(m1,m2,c1,c2,l,g,I1,I2, theta1,theta2,omega1,omega2, kp1, kd1, kp2, kd2, q1_p_ref, q1_v_ref, q1_a_ref, q2_p_ref, q2_v_ref, q2_a_ref)
    # noisy tau here
    M, C, G = EOM(m1,m2,c1,c2,l,g,I1,I2, theta1,theta2,omega1,omega2)
...
def get_ep_joint_traj(l1, l2, x_ref, y_ref, x_d_ref, y_d_ref, x_dd_ref, y_dd_ref):
    ...
    return theta1_ref, theta2_ref, theta1_d_ref, theta2_d_ref, theta1_dd_ref, theta2_dd_ref
...
if __name__=="__main__":
    ...
    for i in range(len(q1_a_ref)-1):
        ...
        ref_args = ( q1_p_ref[i], q1_v_ref[i], q1_a_ref[i], q2_p_ref[i], q2_v_ref[i], q2_a_ref[i] )
        args = (dyn_args, gain_args, ref_args)
                
        t_temp = np.array([ ts[i], ts[i+1] ])
        
        result = odeint(twolink_dynamics, z0, t_temp, args=args)
        tau_temp = get_tau(m1,m2,c1,c2,l,g,I1,I2, 
                           z0[0],z0[2],z0[1],z0[3], 
                           kp1,kd1,kp2,kd2, 
