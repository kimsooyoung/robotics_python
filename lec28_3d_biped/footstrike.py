...
def footstrike(t, z, params):
    ...
    xd, yd, zd = X_hs[0:3]
    phid, thetad, psid = X_hs[3:6]
    phi_lhd, theta_lhd, psi_lhd = X_hs[6:9]
    theta_lkd, phi_rhd, theta_rhd = X_hs[9:12]
    psi_rhd, theta_rkd = X_hs[12:14]
